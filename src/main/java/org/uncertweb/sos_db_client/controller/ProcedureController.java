...
import org.uncertweb.sos_db_client.view.ProcedureView;
 ...
 */
public class ProcedureController implements IController {

	private static final Logger LOG = LogManager.getLogger(ProcedureController.class);
	 ...
	 */
	public ProcedureController(ProcedureView view, MainModel model) {
		...
		public void actionPerformed(ActionEvent event) {
			...
			SwingWorker<Boolean, Void> swingWorker = new SwingWorker<Boolean, Void>() {
				...
				protected Boolean doInBackground() throws Exception {
					...
					List<String> params = view.getProcedureParams();

					model.importIntoDatabase("procedure", params);
				...
				protected void done() {
					...
					if(isDone) {
						EventBus.publish(new InformationMessageEvent("Procedure imported."));
